  ...
  <div id="add-blog">
    ...
    <form v-if="!submitted" action="#">
      ...
      <div id="checkboxes">
        ...
        <label>Makale</label>
        <input type="checkbox" value="Makale" v-model="blog.categories" />
      </div>
      ...
      <p><button v-on:click="gonder()">Blog'lara Ekle</button></p>
    </form>
    <div v-if="submitted">
...
export default {
  data() {
    return {
      ...
      authors: ["Çağlar", "Icardi", "G. Sara", "F. Terim", "Muslera", "Hagi"],
      submitted: false,
      error: null,
    };
  },
